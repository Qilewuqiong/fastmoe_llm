...
from fmoe_llm.functions import ensure_comm
from fmoe_llm.gates.swipe_gate import SwipeGate 
...
def test_swipe_gate(world_size, d_model, batch_size, n_expert, top_k):
    print("test_swipe_gate")
    print("world_size*n_expert: %d"%(world_size*n_expert))
