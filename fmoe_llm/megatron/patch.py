...
def patch_forward_step(forward_step_func, Megatron_Version="v2.2"):
    ...
    def forward_step_with_balance_loss_v2_2(data_iterator, model):
        args = get_args()
...
def patch_model_provider(model_provider, pre_process=True, post_process=True, gate=None, Megatron_Version='v2.2'):
    from megatron import get_args

    def fmoefied_model_provider_v2_2(pre_process=pre_process, post_process=post_process):
